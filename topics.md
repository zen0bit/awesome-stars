...
- [reyamira/pass-cli](https://github.com/reyamira/pass-cli) - A secure, cross-platform, always-free, and open-source alternative to 1password, bitwarden, etc., Password and API key manager for folks who live in the command line. (CLI + TUI)
- [Gaurav-Gosain/tuios](https://github.com/Gaurav-Gosain/tuios) - A terminal window manager that knows what your agents are doing. Tiling panes, workspaces, sessions that survive restarts, and one Inbox for every coding agent.
- [shikaan/keydex](https://github.com/shikaan/keydex) - 🔒 Terminal based password manager for KeePass databases.
...
- [Bharath-code/git-scope](https://github.com/Bharath-code/git-scope) - A fast TUI to see the status of all git repositories on your machine.
- [lucky7xz/drako](https://github.com/lucky7xz/drako) - A grid-based command-deck launcher for the terminal.
- [sharkdp/fd](https://github.com/sharkdp/fd) - A simple, fast and user-friendly alternative to 'find'
- [charmbracelet/vhs](https://github.com/charmbracelet/vhs) - Your CLI home video recorder 📼
...
- [HunnyBon/protontricks](https://github.com/HunnyBon/protontricks) - A simple wrapper that does winetricks things for Proton enabled games, requires Winetricks.
...
- [Quaint-Studios/Reia](https://github.com/Quaint-Studios/Reia) - RPG game action-adventure MMO built with Godot and Rust.
- [Maran23/script-ide](https://github.com/Maran23/script-ide) - Transforms the Script UI into an IDE like UI. Multiline Tabs, Splitting, Outline with unique icons that shows all members of the script. Quick search and function override functionality.
...
- [Botspot/pi-apps](https://github.com/Botspot/pi-apps) - Raspberry Pi App Store for Open Source Projects
- [oSoWoSo/void-artwork](https://github.com/oSoWoSo/void-artwork) - Collection of artworks for Void linux
...
- [d77void/wmd77](https://github.com/d77void/wmd77) - wmd77 is a Penrose Lib Tiling Window Manager
...
- [ed-asriyan/simplex-catalog-frontend](https://github.com/ed-asriyan/simplex-catalog-frontend) - https://simplex-catalog.asriyan.me
...
- [aryvector/void-kernel-builds](https://github.com/aryvector/void-kernel-builds) - Void linux kernel builds using linux-tkg patches and void-packages template
...
- [stud0709/OneMoreSecret](https://github.com/stud0709/OneMoreSecret) - Secrets management based on Android KeyStore, Fingerprint, QR and Bluetooth
...
- [VUP-Linux/vup](https://github.com/VUP-Linux/vup) - VUP + Vuru: A Package manager & User Repo for Void Linux
- [mendescotta/Caerus](https://github.com/mendescotta/Caerus) - A package manager for Void Linux, inspired by Synaptic
- [pkgforge/soar](https://github.com/pkgforge/soar) - A fast, modern, distro-independent package manager that just works [maintainer=@QaidVoid]
- [MuntashirAkon/AppManager](https://github.com/MuntashirAkon/AppManager) - A full-featured package manager and viewer for Android
...
- [mvdan/sh](https://github.com/mvdan/sh) - A shell parser, formatter, and interpreter with bash and zsh support; includes shfmt
- [Kinderfeld/replace-sudo](https://github.com/Kinderfeld/replace-sudo) - Because sudo is a bloated mess.
- [jamielinux/bashmount](https://github.com/jamielinux/bashmount) - Tool to mount and unmount removable media from the command-line
- [xxh/xxh](https://github.com/xxh/xxh) - 🚀 Bring your favorite shell wherever you go through the ssh. Xonsh shell, fish, zsh, osquery and so on.
- [x-cmd/x-cmd](https://github.com/x-cmd/x-cmd) - Shell Superpowers for AI Agents.
- [Speyll/dotfiles](https://github.com/Speyll/dotfiles) - Efficiency meets aesthetics, my dotfiles are fine-tuned for a seamless Linux experience. Take control of your system with this clean, minimalistic configuration. 🚀
